...
module.exports = {
  ...
  overrides: [
    ...
    {
      files: ['src/components/Resume/index.jsx', 'src/components/Project/index.jsx', 'src/components/Portfolio/index.jsx', 'src/components/Post/index.jsx', 'src/templates/*.jsx'],
      rules: {
        'react/no-danger': off,
      },
    },
